...
First-meeting edition, September 2026. Eighteen documents plus diagrams. Every Word document is also provided as a PDF.

## Which documents go to the client, and when

| Stage | Hand over |
|---|---|
| Explaining the plan in simple terms, to anyone | 18 In Plain Words |
...
| 18 | `18_What_We_Will_Do_In_Plain_Words.docx` / `.pdf` | Every point of the client's brief restated in plain language, each with what we will do and what we suggest adding, plus their four questions and the timeline. No jargon; usable as a script for explaining the project verbally | Client sponsor; also the presenter's simplest reference |
