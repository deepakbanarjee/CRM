...
- **Data stays in the client's hands.** The client owns the cloud accounts, the code and the data. Deployment options range from managed cloud in Malaysia or Singapore to fully sovereign in-country hosting, and the choice is a configuration setting. Adding a GCC region when that entity begins trading is the same setting again, not a rebuild.
...
2. A representative sample of 50-200 documents (mixed types and languages, some scanned) under NDA, and the list of decision types management cares about most.
...
Which languages appear in the corpus and in what share; document version control; who adjudicates a flagged contradiction; consent and lawful basis for storing investor personal data under the Malaysian PDPA and the Philippine Data Privacy Act, and whether Philippine data may be held in Malaysia or Singapore; integration with existing systems (ERP, document management, existing CRM); accuracy acceptance criteria; support and disaster-recovery expectations. Each is addressed with a recommendation in Document 13, Gaps, Assumptions and Clarifying Questions.
`,
};
