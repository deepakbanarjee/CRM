...
|---|---|---|---|
| 1 | **Languages.** Arabic is not mentioned, but GCC corporate documents and correspondence are frequently Arabic or bilingual. | Both Arabic and English are required for documents, questions, answers and the interface. | Confirm; include Arabic scanned documents in the sample set. |
| 2 | **Jurisdiction and data residency.** Which country's laws apply and whether data or AI processing may leave the country. | Data at rest in a GCC cloud region; hybrid model routing by classification; sovereign option designed in. | Decide the pattern in discovery with legal; it drives cost tier and provider choice. |
...
| 11 | **Consent and lawful basis** for storing and contacting individuals under PDPL regimes. | Existing relationships provide a lawful basis; consent captured going forward. | Legal to confirm basis per jurisdiction; we implement the fields and flags. |
...
3. Which cloud provider do you already use or prefer, and do you have an existing account in a GCC region?
...
8. Which pipeline stages do relationship managers use today for investors, partners and customers, and what is specific about the GCC pipeline for you (intermediaries, majlis meetings, regulatory steps)?
