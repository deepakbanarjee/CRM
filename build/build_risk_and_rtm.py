...
risks = [
    ...
    ("Delivery", "Underestimated effort for Arabic right-to-left interface and bilingual search", 3, 3, "Arabic in scope from Phase 1, not retrofitted; UX designer on Arabic layout; per-language evaluation", "Full-stack engineer", "Arabic golden-set scores lag English by more than 10 points", "Open"),
...
reqs = [
    ...
    ("N1", "Arabic and English documents, questions, answers and interface (assumed; Document 13 gap 1)", "OCR with Arabic; multilingual embeddings; RTL layout; per-language evaluation", "Intelligence service, web app", "Phase 1-3", "s.6 Answer faithfulness", "Arabic golden-set scores within 10 points of English", "3.2 step 5", "Planned"),
